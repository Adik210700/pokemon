...
part of 'get_pokemon_details_api.dart';
...
class _GetPokemonDetailsApi implements GetPokemonDetailsApi {
  _GetPokemonDetailsApi(this._dio, {this.baseUrl, this.errorLogger}) {
